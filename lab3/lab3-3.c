...
void eval_bus_drivers() {
    ...
    /* input of GateMAR */
    // value_of_GateMAR = ?;
    //info("Lab3-3 assignment: value_of_GateMAR = %d;\n",value_of_GateMAR);
    ...
    //info("Lab3-3 assignment: value_of_shift_function_unit = %d;\n",value_of_shift_function_unit);
    ...
    /* input of GateALUSHF */
    // value_of_GateALUSHF = ?;
    //info("Lab3-3 assignment: value_of_GateALUSHF = %d;\n",value_of_GateALUSHF);
     ...
     */
    /* input of GateRS2 */
    //info("Lab3-3 assignment: value_of_GateRS2 = %d;\n",value_of_GateRS2);
...
void drive_bus() {
    ...
    switch ((_GateMDR << 4) + (_GateRS2 << 3) + (_GatePC << 2) + (_GateALUSHF << 1) + (_GateMAR)) {
        case 0:
            ...
            break;
        case 1:
            //info("Lab3-3 assignment: when value = 1, BUS = %d;\n",BUS);
            BUS = value_of_GateMAR;
            break;
        case 2:
            //info("Lab3-3 assignment: when value = 2, BUS = %d;\n",BUS);
            BUS = value_of_GateALUSHF;
            break;
        case 4:
            //info("Lab3-3 assignment: when value = 4, BUS = %d;\n",BUS);
            BUS = value_of_GatePC;
            break;
        case 8:
            //info("Lab3-3 assignment: when value = 8, BUS = %d;\n",BUS);
            BUS = value_of_GateRS2;
            break;
        case 16:
            //info("Lab3-3 assignment: when value = 16, BUS = %d;\n",BUS);
